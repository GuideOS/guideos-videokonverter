...
# -------------------- Design / Farben --------------------
BG = "#1e1e1e"       # Fensterhintergrund (dunkel)
FIELD = "#2a2a2a"    # Felder / Buttons dunkel
TEXT = "#ffffff"     # Weißer Text
TEXT2 = "#000000"     # Schwarzer Text
ACCENT = "#3a3a3a"   # Akzentfarbe für Rahmen etc.
PROG = "#4b9e8c"     # Fortschrittsbalken (kann bleiben)
FIELD2 = "#947d03"
FIELD3 = "#3d3b3b"
...
listbox = tk.Listbox(list_frame, bg=FIELD3, fg=TEXT, selectmode="extended", height=12, borderwidth=0)
...
log_text = tk.Text(log_frame, height=10, bg=FIELD3, fg=TEXT, wrap="word")
